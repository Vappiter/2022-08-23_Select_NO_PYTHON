...
/* Создание таблицы связи исполнителей к жанрам */
...
/* Создание таблицы связи исполнителей к альбомам */
...
/* Создание таблицы связи сборников и треков */

create table if not exists col_tr (
     collection_id integer references collection (collection_id),
     track_id integer references track (track_id),
     alb_tr_id serial primary key
);
